                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center">
                      <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Loại: {INVESTMENT_TYPES.find((t) => t.value === investment.type)?.label || 'Khác'}
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                        ...
                        <Typography
                          variant="body2"
                          sx={{ color: profitLoss.isProfit ? theme.palette.success.main : theme.palette.error.main }}
                        >
                          {profitLoss.isProfit ? 'Lợi nhuận' : 'Thua lỗ'}: {formatCurrency(profitLoss.amount)} (
                          {profitLoss.percentage}%)
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                          Trạng thái: {investment.status === 'active' ? 'Đang hoạt động' : investment.status === 'completed' ? 'Hoàn thành' : 'Hủy'}
                        </Typography>
                      </Box>
                      <Box>
              ...
              <Box sx={{ textAlign: 'left' }}>
                ...
                >
                  ...
                  {totalProfitLoss.totalInvested > 0
                    ? ((totalProfitLoss.profit - totalProfitLoss.loss) / totalProfitLoss.totalInvested * 100).toFixed(2)
                    : '0.00'}
                  %)
                </Typography>
              </Box>
